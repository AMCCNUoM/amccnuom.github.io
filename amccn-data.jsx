...
const AMCCN_THEMES = [
  { id: 'action',       title: 'Action',                  blurb: 'How the brain plans, executes and refines movement.',
    ...
    labs: [
      ...
      { name: 'Body Eyes and Movement Lab (BEAMLab)', lead: 'Prof Ellen Poliakoff and Prof Emma Gowen', url: '#action-beamlab' },
    ] },
  { id: 'attention',    title: 'Attention',               blurb: 'How we select what to focus on, and ignore what we don\u2019t.',
    ...
    labs: [
      ...
      { name: 'Body Eyes and Movement Lab (BEAMLab)', lead: 'Prof Ellen Poliakoff and Prof Emma Gowen', url: '#attention-beamlab' },
    ] },
  { id: 'modelling',    title: 'Computational modelling', blurb: 'Mathematical accounts of how cognition could work.',
    ...
    labs: [
      ...
      { name: 'Neuroimaging and modelling Group (NIMO)', lead: 'Dr William Lloyd and Prof Laura Parkes', url: '#modelling-nimo' },
  ...
  { id: 'imaging',      title: 'Neuroimaging',            blurb: 'Looking inside the working brain with MRI, MEG and EEG.',
    ...
    labs: [
      ...
      { name: 'Neuroimaging and modelling Group (NIMO)', lead: 'Dr William Lloyd and Prof Laura Parkes', url: '#imaging-nimo' },
  ...
  { id: 'perception',   title: 'Perception',              blurb: 'How the senses build our experience of the world.',
    ...
    labs: [
      ...
      { name: 'Body Eyes and Movement Lab (BEAMLab)', lead: 'Prof Ellen Poliakoff and Prof Emma Gowen', url: '#perception-beamlab' },
    ] },
  { id: 'physiology',   title: 'Physiological measures',  blurb: 'Heart, eye, sweat and skin as windows on the mind.',
    ...
    labs: [
      ...
      { name: 'Neuroimaging and modelling Group (NIMO)', lead: 'Dr William Lloyd, Prof Laura Parkes and Dr Andy Tyler', url: '#physiology-nimo' },
  ...
  { id: 'translational',title: 'Translational work',      blurb: 'Carrying lab findings into clinics and communities.',
    ...
    labs: [
      ...
      { name: 'Neuroimaging and modelling Group (NIMO)', lead: 'Dr William Lloyd, Prof Laura Parkes and Dr Andy Tyler', url: '#translational-nimo' },
      ...
      { name: 'Body Eyes and Movement Lab (BEAMLab)', lead: 'Prof Ellen Poliakoff and Prof Emma Gowen', url: '#translational-beamlab' },
